...
;================================================
If FileExists(@ScriptDir & "\Config\D2.Config.ini") = 0 Then
	LogEvent (1, "Cannot find " & @ScriptDir & "\Config\D2.Config.ini")
	FatalErrorMsg("Cannot find " & @ScriptDir & "\Config\D2.Config.ini")
	Exit
EndIf

$AllVars = IniReadSection(@ScriptDir & "\Config\D2.Config.ini", "oog")
...
LogEvent (0, "========================================")
LogEvent (0, "")
LogEvent (0, "D2.Config.ini Variables loaded.")
;================================================
;Includes
;================================================
...
#Include <Array.au3>
#Include <String.au3>
#Include "Sources/Checksums.au3"
#Include "Sources/OOG.au3"
#include "Sources/Confirmation.au3"
#Include "Sources/PotThread.au3"

;================================================
;Bot Launching GUI
;This has been changed from mmbot. The Launching GUI now controls both Battle and singleplayer mode. There is no longer a SEQ mode.
;================================================
If ($CharMode <> "Battle") AND ($CharMode <> "Single") Then
	FatalErrorMsg(0, "Invalid Game Mode.", @CRLF _
	& "Ensure CharMode is correct in D2.Config.ini. Valid modes are: 'Single', or 'Battle'" & @CRLF)
...
Local $Realms = IniReadSection(@ScriptDir & "\Config\D2.Realms.ini", "D2.Realms")
...
;================================================
		While ProcessExists($InGamePID) AND (IsInGame() = 1)
